...
const OrdersTable: React.FC<OrderTableProps> = ({ orders, onViewOrder, loading }) => {
  if (loading) {
    return (
    ...
    <div className="overflow-x-auto">
      ...
      <div className="bg-green-100 rounded-[10px] px-4 md:px-8 py-3 md:py-4 mb-3 md:mb-4" style={{ backgroundColor: 'rgba(46, 204, 113, 0.17)' }}>
        ...
        <div className="sm:hidden flex items-center justify-between">
          <span className="text-[14px] font-bold text-gray-700">Orders</span>
          ...
          >
            <div className="hidden sm:grid grid-cols-9 gap-1 items-center">
              ...
              <div className="col-span-1 min-w-0">
                <span className="text-[12px] md:text-[12px] font-extrabold text-gray-500 block leading-tight">
                  {order.customer}
                </span>
              </div>
              ...
              <div className="col-span-2 min-w-0">
                <div className="text-[11px] md:text-[11px] font-extrabold text-gray-500 leading-tight">
                  {order.product}
                </div>
              </div>
              ...
              {/* Date */}
              <div className="col-span-1">
                <span className="text-[12px] md:text-[12px] font-extrabold text-gray-500">
