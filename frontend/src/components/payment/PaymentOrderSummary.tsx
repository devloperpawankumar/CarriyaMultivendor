    ...
    <div className={`bg-[#FFFDFD] border border-[#949494] rounded-[12px] p-6 ${className}`}>
      ...
      <div className="space-y-4 mb-6">
        <div className="flex justify-between items-center">
          <span className="text-[15px] text-black">{subtotalLabel}</span>
      ...
      {showProceedButton && (
        <button
          ...
          className={`w-full bg-[#2ECC71] text-white rounded-[10px] py-3 text-[20px] font-semibold transition ${
            proceedDisabled ? 'opacity-60 cursor-not-allowed' : ''
          }`}
        >
          {proceedLabel}
        </button>
