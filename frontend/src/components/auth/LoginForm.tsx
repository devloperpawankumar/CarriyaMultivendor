...
export interface LoginFormProps {
  ...
  submitting?: boolean;
  onFieldChange?: (name: 'email' | 'password') => void;
...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className={`max-w-[352px] md:max-w-[600px] mx-auto lg:mx-0 ${className}`}>
      ...
      {/* General error */}
      {errors?.general && (
        <div className="text-red-500 text-[12px] md:text-[16px] mb-2">{errors.general}</div>
      )}
        ...
        {userType === 'buyer' && (
          <>
            ...
            <div className="flex justify-center">
              <button
                type="button"
                onClick={submitting ? undefined : onGoogleClick}
